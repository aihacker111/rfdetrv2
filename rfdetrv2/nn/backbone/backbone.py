...
from rfdetrv2.nn.backbone.base import BackboneBase
from rfdetrv2.nn.backbone.dinov3 import DinoV3
from rfdetrv2.nn.backbone.convnext_projector import MultiScaleProjector
# from rfdetrv2.nn.backbone.projector import MultiScaleProjector
...
class Backbone(BackboneBase):
    ...
    def get_named_param_lr_pairs(self, cfg, prefix: str = "backbone.0"):
        ...
        """
        num_layers = cfg.out_feature_indexes[-1] + 1
            ...
            if backbone_key in full_name:
                lr = (
                    ...
                    * _get_dino_lr_decay_rate(
                        full_name,
                        lr_decay_rate=cfg.lr_vit_layer_decay,
                        num_layers=num_layers,
                    )
                    * cfg.lr_component_decay ** 2
                )
                wd = cfg.weight_decay * _get_dino_weight_decay_rate(full_name)
