...
def _train_base() -> dict:
    """Keys aligned with ``rfdetrv2.schemas.train.TrainConfig`` plus Pipeline-only fields (num_classes, amp, …)."""
    return {
        # --- mirrors TrainConfig (schemas/train.py) ---
        "lr": 2.0e-4,
        "lr_encoder": 2.5e-5,
        "batch_size": 2,
        "grad_accum_steps": 1,
        ...
        "document_table2_augment": False,
        "document_table2_p": 0.5,
        "use_ema": False,
        "num_workers": 2,
        "weight_decay": 1.0e-4,
        "early_stopping": True,
        ...
        "freeze_decoder": False,
        "freeze_detection_head": False,
        # --- Pipeline / YAML run fields (not on TrainConfig) ---
        "num_classes": 90,
        "amp": False,
        "lr_scale_mode": "sqrt",
        "clip_max_norm": 0.1,
